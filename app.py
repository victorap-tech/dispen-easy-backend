...
PUBLIC_PATHS = {
    ...
    "/api/pagos/preferencia",   # generar link/QR (desde el admin, pero puede usarse sin header)
...
def mp_webhook():
    ...
    # ATENCIÓN: Payments v1 responde igual para sandbox/live; elegimos base por live_mode.
